...
public class CustomerServiceController {
    ...
    public Map<String, Object> getStats() {
        ...
        stats.put("total", serviceRecordService.getServiceCount());
        stats.put("statusStats", serviceRecordService.getStatusStats());
        stats.put("typeStats", serviceRecordService.getTypeStats());
        stats.put("satisfactionStats", serviceRecordService.getSatisfactionStats());
        stats.put("avgHandleTime", serviceRecordService.getAvgHandleTime());
        return stats;
    }
} 