                ...
                <form id="opportunityForm" class="needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="customerId" name="customerId" required>
                                ...
                                <c:forEach items="${customers}" var="customer">
                                    <option value="${customer.id}" ${customer.id == opportunity.customerId ? 'selected' : ''}>
                                        ${customer.name}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="expectedAmount" name="expectedAmount" 
                                       value="${opportunity.expectedAmount}" step="0.01" min="0" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="stage" name="stage" required>
                                ...
                                <c:forEach items="${stages}" var="stageOption">
                                    <option value="${stageOption}" ${stageOption == opportunity.stage ? 'selected' : ''}>
                                        ${stageOption}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="successRate" name="successRate" 
                                       value="${opportunity.successRate}" min="0" max="100" required>
                                <span class="input-group-text">%</span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="expectedClosingDate" name="expectedClosingDate" 
                                   value="<fmt:formatDate value='${opportunity.expectedClosingDate}' pattern='yyyy-MM-dd'/>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                                  rows="3" required>${opportunity.description}</textarea>
    ...
    <script>
        $(function() {
            ...
            form.addEventListener('submit', function(event) {
                ...
                // 发送AJAX请求
                $.ajax({
                    url: '${pageContext.request.contextPath}/sales/opportunity/edit',
                    type: 'POST',
